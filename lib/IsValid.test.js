...
describe('correctStringSize', () => {
    describe('parametru tipai', () => {
        ...
        test('context not a string', () => {
            expect(IsValid.correctStringSize('', 1)).toStrictEqual([false, 'OK']);
        })
        test('max: desimtainis', () => {
            expect(IsValid.correctStringSize('', 'Tekstas', 5.5)).toStrictEqual([true, 'ERROR']);
        })
    })
})